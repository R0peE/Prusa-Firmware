...
static constexpr uint8_t EEPROM_M500_base_ = 20; //offset for storing settings using M500
#define EEPROM_M500_base reinterpret_cast<M500_conf*>(EEPROM_M500_base_)
